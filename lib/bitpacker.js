...
module.exports = function(data, width, height, options) {
  var outHasAlpha = options.colorType === constants.COLORTYPE_COLOR_ALPHA || constants.COLORTYPE_ALPHA;
  if (options.inputHasAlpha && outHasAlpha && (options.inputColorType === options.colorType)) {
    return data;
  }
